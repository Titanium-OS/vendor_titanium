#
# Titanium Audio Files
#

ALARM_PATH := vendor/titanium/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/titanium/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/titanium/prebuilt/common/media/audio/ringtones
