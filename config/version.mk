...
ifeq ($(WITH_GAPPS),true)
    TITANIUM_VERSION := TitaniumOS-$(PLATFORM_VERSION)-v$(TITANIUM_BUILD_VERSION)-$(TITANIUM_BUILD_TYPE)-BETA-GApps-$(TITANIUM_BUILD)-$(TITANIUM_BUILD_DATE)
else
    TITANIUM_VERSION := TitaniumOS-$(PLATFORM_VERSION)-v$(TITANIUM_BUILD_VERSION)-$(TITANIUM_BUILD_TYPE)-BETA-$(TITANIUM_BUILD)-$(TITANIUM_BUILD_DATE)
endif
