...
ifneq ($(USE_CCACHE),)
    ifeq ($(USE_SYSTEM_CCACHE),)
        CCACHE_BIN := $(BUILD_TOP)/prebuilts/tools-titanium/$(HOST_PREBUILT_TAG)/bin/ccache
...
TOOLS_PATH_OVERRIDE := \
    PATH=$(BUILD_TOP)/prebuilts/tools-titanium/$(HOST_OS)-x86/bin:$$PATH \
    LD_LIBRARY_PATH=$(BUILD_TOP)/prebuilts/tools-titanium/$(HOST_OS)-x86/lib:$$LD_LIBRARY_PATH \
