...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := healthd_board_titanium.cpp
LOCAL_MODULE := libhealthd.titanium
LOCAL_CFLAGS := -Werror
LOCAL_C_INCLUDES := \
...
include $$(CLEAR_VARS)
LOCAL_MODULE := vendor_titanium_charger_$(notdir $(1))
...
include $(CLEAR_VARS)
LOCAL_MODULE := titanium_charger_res_images
LOCAL_MODULE_TAGS := optional
